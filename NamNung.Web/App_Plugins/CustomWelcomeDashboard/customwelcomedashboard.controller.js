angular.module("umbraco").controller("CustomWelcomeDashboardController", function ($scope, userService, logResource, entityResource, $http) {
    var vm = this;
    vm.UserName = "guest";
            ...
            angular.forEach(response.items, function (item) {
                ...
                if (item.nodeId > 0) {
                    ...
                    if (item.entityType === "Document") {
                        item.editUrl = "content/content/edit/" + item.nodeId + "?mculture=vi-VN";
                    }
                    if (item.entityType === "Media") {
                        item.editUrl = "media/media/edit/" + item.nodeId + "?mculture=vi-VN";
                    }
